...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 p-4 md:p-8 space-y-6 overflow-y-auto max-w-5xl mx-auto w-full">
      ...
      {feedback && (
        <div className="p-3 rounded-lg bg-sky-50 border border-sky-200 text-sky-800 text-xs font-semibold flex items-center gap-2">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-2xs p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] text-sky-700 bg-sky-50 border border-sky-200 px-2 py-0.5 rounded font-medium">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-2xs p-5 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-4 rounded-lg bg-slate-50 border border-slate-200">
          ...
          <button
            ...
            className="px-3 py-2 text-xs font-semibold text-sky-700 bg-white hover:bg-sky-50 border border-sky-300 rounded-lg transition-colors flex items-center gap-1.5 self-start sm:self-auto"
          >
