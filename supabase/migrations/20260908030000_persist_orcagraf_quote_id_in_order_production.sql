-- Migration: persist OrçaGraf quote id and enforce anti-duplicate constraint on atomic order creation (Hotfix P2-01)
-- Replaces arteflow_create_order_with_production to accept p_orcagraf_quote_id and persist it into arteflow_orders
